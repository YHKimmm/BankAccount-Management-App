...
using static ASP.Net_MVC_Assignment.Services.ReCAPTCHA;

namespace ASP.Net_MVC_Assignment.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var clientID = clientRepo.GetClientId(Input.Email);

                    HttpContext.Session.SetString("UserName", clientID.FirstName);
                    ...
                    var response = await _emailService.SendSingleEmail(new Models.ComposeEmailModel
                    {
                        FirstName = "Bryaden",
                        LastName = "Kim",
                        Subject = "Confirm your email, please check your email inbox",
                        Email = Input.Email,
